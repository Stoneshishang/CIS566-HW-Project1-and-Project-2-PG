...
namespace Project1
{
    class Word90: WordGeneration
    {
        private static WordGeneration instance;

        private Word90(string generationName, GuiComponentFactory componentFactory)
        {
        ...
        public static WordGeneration getInstance(string generationName, GuiComponentFactory componentFactory)
        {
            if (instance == null)
            {
                instance = new Word90(generationName, componentFactory);
            }

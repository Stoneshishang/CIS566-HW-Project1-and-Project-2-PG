...
namespace Project2_P2
{
    public partial class MainForm : Form
    {
        ...
        private void btnConvert_Click(object sender, EventArgs e)
        {
            ...
            // Decorate the converted value with the formats
            RoundingDecorator roundingDecorator = new RoundingDecorator(value);
            value = roundingDecorator.Format();

            ExponentDecorator exponentDecorator = new ExponentDecorator(value);
            value = exponentDecorator.Format();

            UnitDecorator unitDecorator = new UnitDecorator(value, newUnit);
            value = unitDecorator.Format();
